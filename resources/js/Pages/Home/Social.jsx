...
export default function Social({t,social}){
    ...
    return (    	
        ...
        <div className='social-div'>
            ...
            <div className=''>                
            <a href={'https://wa.me/'+social?.whatsapp} target='_blank' className='text-black'>
                    <div 
        ...
        <div className='social-div paragraph-top-separation'>
            ...
            <div className=''>                
                <a href={social?.instagram} target='_blank' className='text-black'>
                    <div 
        ...
        <div className='social-div paragraph-top-separation'>
            ...
            <div className=''>                
                <a href={social?.facebook} target='_blank' className='text-black'>
                    <div 
        ...
        <div className='social-div paragraph-top-separation'>
            ...
            <div className=''>                
                <a href={social?.twitter} target='_blank' className='text-black'>
                    <div 
        ...
        <div className='social-div paragraph-top-separation'>
            ...
            <div className=''>                
                <a href={social?.youtube} target='_blank' className='text-black'>
                    <div 
        ...
        <div className='social-div paragraph-top-separation'>
            ...
            <div className=''>                
                <a href={social?.soundcloud} target='_blank' className='text-black'>
                    <div 
        ...
        <div className='social-div paragraph-top-separation'>
            ...
            <div className=''>                
                <a href={social?.blog} target='_blank' className='text-black'>
                    <div 
        ...
        <div className='social-div paragraph-top-separation'>
            ...
            <div className=''>                
                <a href={social?.ladridos} target='_blank' className='text-black'>
                    <div 
